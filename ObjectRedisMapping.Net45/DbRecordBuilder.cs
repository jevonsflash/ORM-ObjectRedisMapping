namespace Blueve.ObjectRedisMapping
{
    ...
    internal class DbRecordBuilder : IDbRecordBuilder
    {
        ...
        private IEnumerable<PropertyInfo> GetNewPropertyInfos(EntityMetadata entityType)
        {
            entityType.Properties.ToList().Add(entityType.KeyProperty);
        ...
        {
            var result = new List<IDbOperation> {new DbStringRecord(prefix, obj.ToString())};
            return result;
        }
