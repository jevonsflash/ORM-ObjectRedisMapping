namespace Blueve.ObjectRedisMapping
{
    ...
    public class DynamicProxyStub
    {
        ...
        public DateTime DateTimeGetter(string dbKey)
        {
            var s = this.dbClient.KeyExists(dbKey) ? this.dbClient.StringGet(dbKey) : default;
        ...
        public void DateTimeSetter(string dbKey, DateTime value)
        {
            this.dbClient.StringSet(dbKey, value.ToString("O"));
        }
